...
export default function Index() {
  return (
    <div className="text-center bg-white">
      ...
      <Header />
      <Main>
        <div className="mx-auto flex flex-col md:flex-row sm:justify-center lg:justify-around items-center gap-y-7 mt-8 md:mt-72 lg:mt-44 xl:mt-20 mb-10 md:mb-0">
