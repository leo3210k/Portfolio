...
export default function Index() {
  return (
    <div className="text-center bg-white">
      <Header />
      <Main>
        <div class="mx-auto flex justify-around items-center py-32 sm:py-48 lg:py-28 xl:py-24">
          <Image src={profile} className="w-4/12 h-auto" alt="profile"/>
          <div class="w-5/12 flex flex-col items-start">
            <AnimatedText text="Turning Vision Into Reality With Code And Design."
            className="text-4xl text-left font-bold tracking-tight text-gray-900 sm:text-6xl xl:text-7xl"/>
