    ...
    viewport={{ once: true }}>
      ...
      <div className={`lg:w-3/12 ${order ? 'lg:mr-32' : 'lg:ml-32'} flex flex-col justify-center items-center lg:items-baseline gap-y-1 text-left`}>
        ...
        <div className="mt-5 flex gap-x-6">
          ...
          <span className="flex items-center gap-x-2 rounded-md bg-indigo-600 px-3.5 py-2.5 text-lg font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline">Visit Project</span>
        </div>
      </div>
    </motion.div>
  )
