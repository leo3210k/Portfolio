  ...
  return (
    <nav className="menu flex flex-col bg-gradient-to-tr from-[#ff80b5] to-[#9089fc]">
      <ul className="space-y-2">
        <CustomLink href="/" title="Home" className="mx-4 block px-3 py-2 text-base font-semibold leading-7 text-black bg-white p-2 rounded-xl" background="black" />
        <CustomLink href="/about" title="About" className="mx-4 block px-3 py-2 text-base font-semibold leading-7 text-black bg-white p-2 rounded-xl" background="black" />
        <CustomLink href="/projects" title="Projects" className="mx-4 block px-3 py-2 text-base font-semibold leading-7 text-black bg-white p-2 rounded-xl" background="black" />
      </ul>
